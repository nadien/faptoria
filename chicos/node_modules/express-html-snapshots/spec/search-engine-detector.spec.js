describe('Search Engine Detector', function () {
    var searchEngineDetector = require('../src/search-engine-detector');

    describe('isGoogleBot', function () {
        it('should detect Google Bot', function () {
    ...
    describe('isBingBot', function () {
        it('should detect Bing Bot', function () {
    ...
    describe('isYahooBot', function () {
        it('should detect Yahoo Bot', function () {
    ...
    describe('isSearchEngineBot', function () {
        it('should detect search engines', function () {
