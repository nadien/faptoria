...
var htmlSnapshots = require('html-snapshots');
    ...
    mongoose.connect('mongodb://localhost/faptoriaHombres');
    ...
    htmlSnapshots.run({
      input: "sitemap",
      source: "http://localhost:9990/sitemap.xml",
...
app.listen(process.env.PORT || 9990 , function(port){
  console.log('Corriend en puerto 9990');
});
